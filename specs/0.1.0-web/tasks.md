# Implementation Plan — ops-union MVP

Cada tarefa aponta o **Copilot custom agent responsável**: `@ops-union-backend`,
`@ops-union-frontend` ou `@ops-union-integration-qa`. As tarefas seguem as fases do `docs/PLANO.md` e
...
- [x] 1. Estruturar o monorepo e as configs base
  ...
  - _Copilot agents: @ops-union-backend (backend + raiz), @ops-union-frontend (frontend)_
